...
<body>
<form class="layui-form" action="submitEditReader.action" method="post" id="editReader" lay-filter="example">
    <div class="layui-form-item">

        <div class="layui-inline">
            <label class="layui-form-label">借阅号：</label>
            <div class="layui-input-inline">
                <input type="text" id="reader_id" name="reader_id"  value=${reader_id} readonly required lay-verify="required" autocomplete="off" class="layui-input">
